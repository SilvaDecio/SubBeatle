...
namespace SubBeatle.Management
{
    ...
    public class StateManager : DrawableGameComponent
    {
        ...
        public StateManager(Game game) : base(game)
        {
            ...
            PathForRecords = "SubBeatle_Records.xml";
        ...
        public override void Initialize()
        {
            ...
            MenuSong = Game.Content.Load<Song>("Audio/Songs/Menu_GamePlay");
            GamePlaySong = Game.Content.Load<Song>("Audio/Songs/Menu_GamePlay");
